...
export function CampaignVisual() {
  ...
  return (
    <div className="relative hidden min-h-dvh overflow-hidden bg-[#f4876a] lg:block">
      ...
      <div className="absolute top-8 right-0 left-0 text-center xl:top-10">
        <p className="text-[13px] font-extrabold tracking-[0.34em] text-white/95 uppercase">
          Invest in your body
        </p>
      ...
      <div className="absolute right-6 bottom-6 left-6 flex flex-wrap items-end justify-between gap-3 xl:right-7 xl:bottom-7 xl:left-7">
        <div className="max-w-[21rem] animate-[gentle-float_6s_ease-in-out_infinite] rounded-2xl bg-[#f8f8f8] p-4 shadow-xl">
